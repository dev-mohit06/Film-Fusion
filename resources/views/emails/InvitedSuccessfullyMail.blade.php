    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td align="center" style="background-color: #007bff; padding: 20px;">
                <h1 style="color: white;">Congratulations dear,</h1>
            </td>
        </tr>
    <tr>
            <td style="padding: 20px;">
                <p>We noticed that your friend tried to register using your referral code, and we are pleased to inform you that we are extending your subscription by 10 days. If you refer more friends and they successfully register, you can earn additional days in your subscription.</p>
