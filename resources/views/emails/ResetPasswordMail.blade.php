...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;">
    ...
    <tr>
            <td style="padding: 20px;">
                ...
                <p>We have noticed that you have tryed to reset your password on our platform. Please proceed with the verification process.</p>
                <p>Activation Link: <strong><a href="{{ route('forget_password.verifylink',['token'=>$mailData['token']]) }}">Click here</a></strong></p>
